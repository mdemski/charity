...
<section class="about-us">
    <div class="about-us--text">
        ...
        <img src="${imagesUrl}signature.svg" class="about-us--text-signature" alt="Signature"/>
    </div>
    <div class="about-us--image"><img src="${imagesUrl}about-us.jpg" alt="People in circle"/>
    </div>
</section>
