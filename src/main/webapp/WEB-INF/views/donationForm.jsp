            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        <h4>Adres odbioru</h4>
                        <div class="form-group form-group--inline">
                            <form:label path="street"> Ulica <form:input path="street" type="text"/> </form:label>
                        </div>

                        <div class="form-group form-group--inline">
                            <form:label path="city"> Miasto <form:input type="text" path="city"/> </form:label>
                        </div>
                    ...
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <form:label path="pickUpDate"> Data <form:input type="date" path="pickUpDate"/>
                            </form:label>
                        </div>

                        <div class="form-group form-group--inline">
                            <form:label path="pickUpTime"> Godzina <form:input type="time" path="pickUpTime"/>
                            </form:label>
                        </div>
